...
/* NOTE(Karan): Camera structure design dilemma:
...
Design 2: We store only camera position and rotation values
    ...
    Going with design 3 since it has cost savings of both design 1 & 2, just need to be careful to use the function for writes to rotation and axis*/
